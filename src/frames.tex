...
\begin{frame}
  ...
  \begin{itemize}
    \item insert to the main table
      \pause
      \begin{itemize}
        \item \sqlinline{11} $\mapsto$ \sqlinline{'{1, 3, 5, 3}'}
      \end{itemize}
      \pause
    \item insert to the secondary index
      ...
      \begin{itemize}
        ...
        \item write records \emph{entry} $\mapsto$ \emph{pk}:
          \pause
          \begin{itemize}
            \item \sqlinline{1} $\mapsto$ \sqlinline{11}
              \pause
            \item \sqlinline{3} $\mapsto$ \sqlinline{11}
              \pause
            \item \sqlinline{5} $\mapsto$ \sqlinline{11}
          \end{itemize}
      \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    \item \sqlinline{1} $\mapsto$ \sqlinline{11}
    \item \sqlinline{1} $\mapsto$ \sqlinline{12}
    \item \sqlinline{2} $\mapsto$ \sqlinline{12}
    \item \sqlinline{3} $\mapsto$ \sqlinline{11}
    \item \sqlinline{3} $\mapsto$ \sqlinline{12}
    \item \sqlinline{3} $\mapsto$ \sqlinline{13}
    \item \sqlinline{5} $\mapsto$ \sqlinline{11}
    \item \sqlinline{5} $\mapsto$ \sqlinline{13}
  \end{itemize}
\end{frame}
